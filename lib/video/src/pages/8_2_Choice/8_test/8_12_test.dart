    ...
    return SafeArea(
      child: Scaffold(
        body: Column(
          ...
          children: [
            SizedBox(height: 5),
            Text('12단원. 복습 시험', style: TextStyle(fontSize: 18+size, color: Colors.black, fontWeight: FontWeight.bold)),
            SizedBox(height: 5),
            Container(
              height: 300,
            ...
            Row(
              ...
              children: [
                ...
                TestButton(text: '목소리', icon: Icons.mic,  color: Colors.blueAccent, state: state1,onTap: Choice822(),), //StartPage()
              ],
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                ...
                TestButton(text: '목소리', icon: Icons.mic,  color: Colors.blueAccent, state: state1,onTap: Choice824(),),
              ],
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                ...
                TestButton(text: '목소리', icon: Icons.mic,  state: state1,color: Colors.blueAccent,onTap: Choice826(),),
              ],
            ),
