  ...
  void checkWin(String userChoice, BuildContext context) {
    ...
    if (newtext == qList[counter].qText.replaceAll(' ', '')) {
      ...
      final snackbar = SnackBar(
        ...
        content: Container(
          child: Icon(
              Icons.brightness_1_outlined, color: Colors.orange, size: 170),
        ),);
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      RaisedButton(
                        ...
                        child: Text("채점", style: TextStyle(color: Colors.white,
                            fontSize: 16.sp + size,
                            fontWeight: FontWeight.bold),),
                      ),
                      ...
                      Container(
                        ...
                        child: IconButton(
                          ...
                          icon: recognizing
                              ...
                              : Icon(
                              Icons.mic, color: Color(0xff4573cb), size: 45),
                        ),
                      ...
                      InkWell(
                        child: RaisedButton(
                          ...
                          child: Text("글씨 지우개", style: TextStyle(color: Colors
                              .white,
                              fontSize: 16.sp + size,
                              fontWeight: FontWeight.bold),),
                        ),
