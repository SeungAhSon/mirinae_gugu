            ...
            child: ListView(
                ...
                children: <Widget>[
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text('ㅃ',style: TextStyle(fontSize: 19+size, fontWeight: FontWeight.bold))
                      ),
                      SizedBox(width: 10.w),
                  ...
                  Container(
                    ...
                    child: Text('입술소리',style:TextStyle(fontSize: 16+size)),
                  ),
                  Text('윗입술과 아랫입술을 살짝 붙였다 떼며 발음',style:TextStyle(fontSize: 15+size),textAlign: TextAlign.center,),
