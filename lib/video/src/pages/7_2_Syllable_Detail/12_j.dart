        ...
        child: Scrollbar(
            child: ListView(
                ...
                children: <Widget>[
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          child: Text('ㅈ',style: TextStyle(fontSize: 19+size, fontWeight: FontWeight.bold))
                      ),
                      SizedBox(width: 10),
                  ...
                  Text('센입천장소리 : 혓바닥을 입안 앞쪽에 붙였다가 떼면서 발음',style:TextStyle(fontSize: 15+size),textAlign: TextAlign.center,),
                  SizedBox(height: 10),
                  Row(
