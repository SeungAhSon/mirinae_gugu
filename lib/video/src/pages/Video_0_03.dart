...
import 'Video_0_04.dart';



class Video0_03 extends StatefulWidget {
  @override
  _Video0_03 createState() => _Video0_03();
}

class _Video0_03 extends State<Video0_03>{
    ...
    return WillPopScope(
        ...
        child: Scaffold(
            appBar: AppBar(
              ...
              actions: <Widget>[
                IconButton(
                  onPressed: favoriteButton_0_03 ? delete : saved,
                  icon: favoriteButton_0_03
        ...
        IconButton(
            ...
            onPressed: () async {
              await Navigator.push(
                  context, CupertinoPageRoute(builder: (context) => Video0_04()));
            }
        ),
      ],
    );
