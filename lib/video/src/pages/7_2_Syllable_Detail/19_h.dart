            ...
            child: ListView(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Text('마찰음',style:TextStyle(fontSize: 16+size)),
                  ),
                  ...
                  Container(
                    ...
                    child: Text('목청소리',style:TextStyle(fontSize: 16+size)),
                  ),
                  Text('목구멍에서 나는 소리',style:TextStyle(fontSize: 15+size),textAlign: TextAlign.center,),
