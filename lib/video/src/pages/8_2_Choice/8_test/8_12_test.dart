          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                TestButton(text: '목소리', icon: Icons.mic,  color: Colors.blueAccent, state: state1,onTap: Choice22(),), //StartPage()
              ],
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                ...
                TestButton(text: '목소리', icon: Icons.mic,  color: Colors.blueAccent, state: state1,onTap: Choice24(),),
              ],
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                ...
                TestButton(text: '목소리', icon: Icons.mic,  state: state1,color: Colors.blueAccent,onTap: Choice26(),),
              ],
            ),
