...
class ScoreScreen_5 extends StatefulWidget {
  ScoreScreen_5({Key? key}) : super(key : key);
  @override
  _ScoreScreenState createState() => _ScoreScreenState();
}

class _ScoreScreenState extends State<ScoreScreen_5> {
  ...
  QuestionController_5 _qnController = Get.put(QuestionController_5());
