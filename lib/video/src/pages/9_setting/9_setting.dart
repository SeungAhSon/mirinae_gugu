          ...
          children: [
            ...
            Row(
              children: [
                ...
                SizedBox(width:10.w),
                Text("환경",style: TextStyle(fontSize: 22.sp+size,fontWeight: FontWeight.bold),)
              ],
            ),
            Divider(height: 20.h,thickness: 3,),
            SizedBox(height: 5.h,),
          ...
          return AlertDialog(
            ...
            actions: [
              TextButton(
                ...
                child: Text("닫기",style: TextStyle(color: Colors.black,fontSize: 14.sp),),
              )
            ],
          );
        });
        ...
        children: [
          ...
          Container(
            child: Padding(
              ...
              child: Text("1.0.1+1",style: TextStyle(
                  fontSize: 18.sp+size,
